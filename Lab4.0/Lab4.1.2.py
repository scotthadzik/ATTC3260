...
print ("Set R to " + str(setRedColor)  + ' With a duty cyle of ' + str(Red_Signal_Duty_Cycle))
print ("Set G to " + str(setGreenColor)+ ' With a duty cyle of ' + str(Green_Signal_Duty_Cycle))
print ("Set B to " + str(setBlueColor) + ' With a duty cyle of ' + str(Blue_Signal_Duty_Cycle))
